...
if(mySession==null){
	...
	response.setHeader("refresh", "5;url='/PhaseTwo_LearnersAcademy'");
}
else{
...
<tr><td>&nbsp;&nbsp;<a href="/PhaseTwo_LearnersAcademy/Dashboard.jsp">Dashboard</a>&nbsp;&nbsp;</td></tr>
</table>
<br/>
...
<%} else{
response.sendRedirect("/PhaseTwo_LearnnersAcademy/Dashboard.jsp");
%>
